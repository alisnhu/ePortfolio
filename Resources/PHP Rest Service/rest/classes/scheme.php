...
*/
    ...
    $add = array(
        ...
        "method" => array(
            "get" => array(
                "explanation" => "Retrieve inventory list or a specific inventory item",
            ...
            "post" => array(
                "explanation" => "Add a new inventory item",
            ...
            "patch" => array(
                "explanation" => "Update an existing inventory item",
                "fields" => "sessionToken -string, inventoryName -string, inventoryID -int",
                "return-field" => "status - boolean(true success, false failed), message - string (explanation), result null"
            ),
            "delete" => array(
                "explanation" => "Delete an inventory item",
